...
gnv_restclient.RetrieveWithModel(lds_data, gs_host + "/RetrieveWithModel", ldt_from, ldt_to )
...
gnv_restclient.RetrieveWithModel(lds_data, gs_host + "/RetrieveWithModel", ldt_from1, ldt_to1 )
...
gnv_restclient.RetrieveWithModel(lds_data, gs_host + "/RetrieveWithModel", ll_categoryid,  ll_monthfrom, ll_monthto)
...
gnv_restclient.RetrieveWithModel(lds_data, gs_host + "/RetrieveWithModel", ll_subcategoryid,  ll_monthfrom, ll_monthto)
...
gnv_restclient.RetrieveWithModel(adwc_proc, gs_host + "/RetrieveWithModel", ll_subcategoryid, ldt_from, ldt_to)
//adwc_proc = 
...
gnv_restclient.RetrieveWithModel(lds_lastyear, gs_host + "/RetrieveWithModel", ldt_lastfrom,  ldt_lastto )
...
gnv_restclient.RetrieveWithModel(ldwc_child, gs_host + "/RetrieveWithModel", ldt_from, ldt_to )
...
//ldwc_child.SetTransObject(Sqlca)
//ldwc_child.Retrieve( )
ll_return = gnv_restclient.RetrieveWithModel(ldwc_child, gs_host + "/RetrieveWithModel" )
If ll_Return = -1 Then
